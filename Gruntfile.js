/*!
 * JEC GlassCat Metadata Gruntfile.js
...
/*
 * Provides tasks for building and testing the jec-glasscat-metadata project.
 */
module.exports = function(grunt) {
  ...
  grunt.config("typedoc", {
    doc: {
      ...
      options: {
        ...
        readme: "README.md",
        name: "JEC GlassCat Metadata Project",
        exclude: "**/*Test*.ts"
      }
    }
  });
  ...
  /*!
   * JEC GlassCat Metadata Tasks:
   */

  //--> Task: builds the "jec-glasscat-metadata" project:
  grunt.registerTask("build", ["ts:build", "copy:main",
                               "copy:initTypes", "copy:buildTypesFile",
                               "clean:build"]);

  //--> Task: builds the "jec-glasscat-metadata" API documentation:
